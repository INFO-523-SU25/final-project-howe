...
consists of 332416 rows and 9 columns. To condense the dataset, I filtered out all rows with a count of 0, and reduced the scope to the years 2020-2022. 
...
consists of 9 columns and 66049 rows. 


The second dataset of interest is 'BACRIM2020_Nodes' sourced from Mexico's official government branch Centro Geo. This dataset was put together by piecing 
...
and 'Group' columns. I would like to investigate whether there is a present correlation between high crime rates and high cartel presence. 
...
print('Mexico Cartels DF Shape:', cartels.shape)


#creating column to represent number of crimes per state
crimes_per_state = mexi_crimes.groupby('entity')['count'].sum().reset_index()
crimes_per_state['entity'] =crimes_per_state['entity'].replace({'Yucat?n': 'Yucatán', 'Quer?taro': 'Querétaro', 'Michoac?n de Ocampo': 'Michoacán', 'Nuevo León': 'Nuevo Leon', 'San Luis Potos?': 'San Luis Potosí'}) # correct punctuation in state names
